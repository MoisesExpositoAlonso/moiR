...
if(is.factor(cormeltsub$Var1)){ cormeltsub$Var1 <- as.character.factor(cormeltsub$Var1) }
if(is.factor(cormeltsub$Var2)){ cormeltsub$Var2 <- as.character.factor(cormeltsub$Var2) }
return(cormeltsub)
}
